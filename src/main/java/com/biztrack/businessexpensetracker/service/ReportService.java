...
public class ReportService implements IService<Report>, IExpenses {
    ...
    public ResponseEntity<Object> save(Report report, HttpServletRequest request) {
        try {
            ...
            report.setCreatedBy(UUID.fromString(tokenData.get("id").toString()));
            report = reportRepo.save(report);

            for (ReportDetail reportDetail: report.getReportDetails()){
                reportDetail.getReport().setId(report.getId());
                reportDetail.setCreatedBy(UUID.fromString(tokenData.get("id").toString()));
                reportDetailRepo.save(reportDetail);
            }

        } catch (Exception e) {
            return GlobalResponse.dataGagalDisimpan("BIZ06FE001", request);
        }
    ...
    public ResponseEntity<Object> update(
        ...
        try {
            ...
            if (!opReport.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV013", request);
            }
            ...
            reportDB.setModifiedBy(UUID.fromString(tokenData.get("id").toString()));
            ...
            for (ReportDetail reportDetail: report.getReportDetails()){
                ...
                if (opReportDetail.isPresent()){
                    ...
                    reportDetailDB.setModifiedBy(UUID.fromString(tokenData.get("id").toString()));
                }
            }
        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ06FE011", request);
        }
    ...
    public ResponseEntity<Object> delete(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Report> opReport = reportRepo.findById(id);
            if (!opReport.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV022", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ06FE021", request);
        }
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        ...
        try {
            ...
            if (page.isEmpty()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV031", request);
            }
            listDTO = mapToDTO(page.getContent());
            data = tp.transformPagination(listDTO, page, "id", "");
        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ06FE031", request);
        }
    ...
    public ResponseEntity<Object> cancel(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Report> opReport = reportRepo.findById(id);
            if (!opReport.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV101", request);
            }

            Report reportDB = opReport.get();
            if (reportDB.getStatus().getId() != 3L){
                return GlobalResponse.dataGagalDiubah("BIZ06FV102", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ06FE101", request);
        }
        return GlobalResponse.dataBerhasilDiubah(request);
    }
    ...
    public ResponseEntity<Object> approve(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Report> opReport = reportRepo.findById(id);
            if (!opReport.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV111", request);
            }

            Report reportDB = opReport.get();
            if (reportDB.getStatus().getId() != 3L){
                return GlobalResponse.dataGagalDiubah("BIZ06FV112", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ06FE111", request);
        }
        return GlobalResponse.dataBerhasilDiubah(request);
    }
    ...
    public ResponseEntity<Object> reject(Long id, String comment, HttpServletRequest request) {
        try {
            ...
            Optional<Report> opReport = reportRepo.findById(id);
            if (!opReport.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ06FV121", request);
            }

            Report reportDB = opReport.get();
            if (reportDB.getStatus().getId() != 3L){
                return GlobalResponse.dataGagalDisimpan("BIZ06FV122", request);
            }
