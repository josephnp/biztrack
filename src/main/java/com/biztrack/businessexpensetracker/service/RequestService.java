...
public class RequestService implements IService<Request>, IExpenses {
    ...
    public ResponseEntity<Object> save(Request expensesRequest, HttpServletRequest request) {
        try {
            ...
            User user = new User();
            user.setId(UUID.fromString(tokenData.get("id").toString()));
            ...
            expensesRequest.setCreatedBy(UUID.fromString(tokenData.get("id").toString()));
            ...
            for (RequestDetail requestDetail: expensesRequest.getRequestDetails()){
                ...
                requestDetail.setCreatedBy(UUID.fromString(tokenData.get("id").toString()));

                requestDetailRepo.save(requestDetail);
            }

        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ05FE001", request);
        }
    ...
    public ResponseEntity<Object> update(
        ...
        try {
            ...
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV013", request);
            }

            Request requestDB = opRequest.get();
            if (requestDB.getStatus().getId() != 2L &&
                    requestDB.getStatus().getId() != 4L){
                return GlobalResponse.dataGagalDiubah("BIZ05FV014", request);
            }
            ...
            requestDB.setModifiedBy(UUID.fromString(tokenData.get("id").toString()));
            ...
            for (RequestDetail requestDetail: expensesRequest.getRequestDetails()){
                ...
                if (opRequestDetail.isPresent()){
                    ...
                    requestDetailDB.setModifiedBy(UUID.fromString(tokenData.get("id").toString()));
                }
            }
        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ05FE011", request);
        }
    ...
    public ResponseEntity<Object> delete(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Request> opRequest = requestRepo.findById(id);
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV022", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ05FE021", request);
        }
    ...
    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request) {
        ...
        try {
            ...
            if (page.isEmpty()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV031", request);
            }
            listDTO = mapToDTO(page.getContent());
            data = tp.transformPagination(listDTO, page, "id", "");
        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ05FE031", request);
        }
    ...
    public ResponseEntity<Object> cancel(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Request> opRequest = requestRepo.findById(id);
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV101", request);
            }

            Request requestDB = opRequest.get();
            if (requestDB.getStatus().getId() != 1L){
                return GlobalResponse.dataGagalDiubah("BIZ05FV102", request);
            }

            Status status = new Status();
            status.setId(2L);
            status.setModifiedBy(UUID.fromString(tokenData.get("id").toString()));

            requestDB.setStatus(status);
        } catch (Exception e) {
            return GlobalResponse.terjadiKesalahan("BIZ05FE101", request);
        }
        return GlobalResponse.dataBerhasilDiubah(request);
    }
    ...
    public ResponseEntity<Object> approve(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Request> opRequest = requestRepo.findById(id);
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV111", request);
            }

            Request requestDB = opRequest.get();
            if (requestDB.getStatus().getId() != 3L){
                return GlobalResponse.dataGagalDiubah("BIZ05FV112", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ05FE111", request);
        }
        return GlobalResponse.dataBerhasilDiubah(request);
    }
    ...
    public ResponseEntity<Object> reject(Long id, String comment, HttpServletRequest request) {
        try {
            ...
            Optional<Request> opRequest = requestRepo.findById(id);
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV121", request);
            }

            Request requestDB = opRequest.get();
            if (requestDB.getStatus().getId() != 1L){
                return GlobalResponse.dataGagalDisimpan("BIZ05FV122", request);
            }
    ...
    public ResponseEntity<Object> approveManager(Long id, HttpServletRequest request) {
        try {
            ...
            Optional<Request> opRequest = requestRepo.findById(id);
            if (!opRequest.isPresent()) {
                return GlobalResponse.dataTidakDitemukan("BIZ05FV131", request);
            }

            Request requestDB = opRequest.get();
            if (requestDB.getStatus().getId() != 1L){
                return GlobalResponse.dataGagalDiubah("BIZ05FV132", request);
            }
            ...
            return GlobalResponse.terjadiKesalahan("BIZ05FE131", request);
        }
        return GlobalResponse.dataBerhasilDiubah(request);
    }
